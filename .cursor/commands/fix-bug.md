...
This command guides fixing a bug in an existing ESLint rule. It builds the LLM prompt directly from the GitHub issue body and intentionally omits the `rule-request` flag to avoid expanded test prompts.
