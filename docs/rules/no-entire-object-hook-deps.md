...
💭 This rule requires [type information](https://typescript-eslint.io/linting/typed-linting). It will still run without type info but with reduced accuracy (may miss or misclassify some deps).
