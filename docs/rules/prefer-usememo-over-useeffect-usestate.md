# Prefer useMemo over useEffect + useState for pure computations to avoid extra renders and stale derived state (`@blumintinc/blumint/prefer-usememo-over-useeffect-usestate`)
