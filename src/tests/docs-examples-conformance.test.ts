...
// Re-exported so existing importers of this suite keep working; the definitions
// live in `src/utils/docsFixtures.ts` so a second guard cannot hand-roll them.
export {
  headingPolarity,
  extractBlocks,
  filenameHint,
...
export const SILENT_INCORRECT_STATEMENTS: Record<string, string> = {
  ...
  'enforce-firestore-set-merge:187:3':
  ...
  'enforce-firestore-set-merge:187:6':
