...
ruleTesterTs.run('enforce-microdiff', enforceMicrodiff, {
  valid: [
    ...
    {
      code: `
        function checkSimpleEquality(user, otherUser) {
    ...
    {
      code: `
        function checkSpecificField(user, previousUser) {
  ...
  invalid: [
    // Using deep-diff
    {
      ...
      `,
      errors: [
        { messageId: 'enforceMicrodiffImport', data: { importSource: 'deep-diff' } },
    ...
    // Using deep-object-diff
    {
      ...
      `,
      errors: [
        { messageId: 'enforceMicrodiffImport', data: { importSource: 'deep-object-diff' } },
        { messageId: 'enforceMicrodiff' }
      ],
      output: `
        import { diff } from 'microdiff';
    ...
    // Using fast-diff
    {
      ...
      `,
      errors: [
        { messageId: 'enforceMicrodiffImport', data: { importSource: 'fast-diff' } }
      ],
      output: `
        import { diff } from 'microdiff';
    ...
    // Using fast-deep-equal
    {
      ...
      `,
      errors: [
        { messageId: 'enforceMicrodiffImport', data: { importSource: 'fast-deep-equal' } },
        { messageId: 'enforceMicrodiff' }
      ],
      output: `
        import { diff } from 'microdiff';
    ...
    // Using fast-deep-equal with ES6 import
    {
      ...
      `,
      errors: [
        { messageId: 'enforceMicrodiffImport', data: { importSource: 'fast-deep-equal/es6' } },
        { messageId: 'enforceMicrodiff' }
      ],
      output: `
        import { diff } from 'microdiff';
    ...
    {
      code: `
        function stateHasUpdated(prevState, nextState) {
