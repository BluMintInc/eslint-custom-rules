...
export const preferFragmentComponent = createRule<[], MessageIds>({
  ...
  create(context) {
     ...
     */
    function findReactFragmentParent(node: TSESTree.Node): TSESTree.JSXElement | null {
     ...
     */
    function isInsideJSXFragment(node: TSESTree.Node): TSESTree.JSXFragment | null {
      let current: TSESTree.Node | undefined = node;
      ...
      JSXFragment(node) {
        ...
        const hasReactFragmentChild = node.children.some(
          child => 
            ...
            child.openingElement.name.type === AST_NODE_TYPES.JSXMemberExpression &&
            child.openingElement.name.object.type === AST_NODE_TYPES.JSXIdentifier &&
            child.openingElement.name.object.name === 'React' &&
            child.openingElement.name.property.type === AST_NODE_TYPES.JSXIdentifier &&
