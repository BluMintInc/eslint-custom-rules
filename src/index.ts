...
import enforceNextjsDynamic from './rules/enforce-nextjs-dynamic';
...
module.exports = {
  ...
  configs: {
    recommended: {
      ...
      rules: {
        ...
        '@blumintinc/blumint/enforce-nextjs-dynamic': 'error',
      },
    },
  },
  ...
  rules: {
    ...
    'enforce-nextjs-dynamic': enforceNextjsDynamic,
  },
};
