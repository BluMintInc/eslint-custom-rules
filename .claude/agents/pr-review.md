---
name: pr-review
description: "Use when resolving human PR review comments."
...
- Only pause if blocked by missing information or required approval; use the `AskUserQuestion` tool to ask for exactly what you need, then continue.
...
4.  **Update Documentation**: If applicable, update any related `.claude/skills/*/SKILL.md` documentation guides to incorporate the captured insights and reflect current behavior and design decisions (follow the `system-documentation` skill).
...
- Follow `.claude/skills/task-completion-standards/SKILL.md` for linting, testing, and documentation before finishing.
