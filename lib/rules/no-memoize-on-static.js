                    ...
                    for (const decorator of node.decorators) {
                        ...
                        (expr.type === utils_1.AST_NODE_TYPES.CallExpression &&
                            ...
                            context.report({
                                ...
                                data: {
                                    methodName: (0, getMethodName_1.getMethodName)(node, sourceCode, {
