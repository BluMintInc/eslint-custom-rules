...
exports.noArrayLengthInDeps = (0, createRule_1.createRule)({
    ...
    meta: {
        type: 'problem',
        docs: {
            description: 'Prevent using array.length in React hook dependency arrays. Instead, memoize stableHash(array) with useMemo and depend on the hash.',
            recommended: 'error',
        },
        fixable: 'code',
        schema: [
        ...
        messages: {
            noArrayLengthInDeps: 'Avoid using array.length in hook dependency arrays. Use a memoized stableHash(variable) via useMemo and depend on the hash instead.',
        },
    },
    defaultOptions: [{}],
    create(context) {
