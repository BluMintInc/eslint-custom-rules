        ...
        function hasTypeAnnotation(node) {
            ...
            while (current) {
                ...
                if (current.type === utils_1.AST_NODE_TYPES.ReturnStatement) {
                    let func = current.parent;
                    while (func &&
                        func.type !== utils_1.AST_NODE_TYPES.FunctionDeclaration &&
                        func.type !== utils_1.AST_NODE_TYPES.FunctionExpression &&
                        func.type !== utils_1.AST_NODE_TYPES.ArrowFunctionExpression) {
                        func = func.parent;
                    }
                    if (func &&
                        (func.type === utils_1.AST_NODE_TYPES.FunctionDeclaration ||
