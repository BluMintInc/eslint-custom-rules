...
const no_console_error_1 = require("./rules/no-console-error");
...
const enforce_early_destructuring_1 = require("./rules/enforce-early-destructuring");
...
const no_redundant_annotation_assertion_1 = require("./rules/no-redundant-annotation-assertion");
...
const no_redundant_this_params_1 = require("./rules/no-redundant-this-params");
...
const no_unmemoized_memo_without_props_1 = require("./rules/no-unmemoized-memo-without-props");
...
const prefer_docsetter_setall_1 = require("./rules/prefer-docsetter-setall");
...
const enforce_stable_hash_spread_props_1 = require("./rules/enforce-stable-hash-spread-props");
...
const flatten_push_calls_1 = require("./rules/flatten-push-calls");
const enforce_timestamp_now_1 = require("./rules/enforce-timestamp-now");
const enforce_unique_cursor_headers_1 = require("./rules/enforce-unique-cursor-headers");
...
const no_unnecessary_destructuring_rename_1 = require("./rules/no-unnecessary-destructuring-rename");
...
const logical_top_to_bottom_grouping_1 = require("./rules/logical-top-to-bottom-grouping");
...
const no_usememo_for_pass_by_value_1 = require("./rules/no-usememo-for-pass-by-value");
...
const no_empty_dependency_use_callbacks_1 = require("./rules/no-empty-dependency-use-callbacks");
...
const memo_compare_deeply_complex_props_1 = require("./rules/memo-compare-deeply-complex-props");
...
const no_curly_brackets_around_commented_properties_1 = require("./rules/no-curly-brackets-around-commented-properties");
const no_res_error_status_in_onrequest_1 = require("./rules/no-res-error-status-in-onrequest");
const no_try_catch_already_exists_in_transaction_1 = require("./rules/no-try-catch-already-exists-in-transaction");
const memo_nested_react_components_1 = require("./rules/memo-nested-react-components");
const no_useless_usememo_primitives_1 = require("./rules/no-useless-usememo-primitives");
const jsdoc_above_field_1 = require("./rules/jsdoc-above-field");
const enforce_transform_memoization_1 = require("./rules/enforce-transform-memoization");
const vertically_group_related_functions_1 = require("./rules/vertically-group-related-functions");
...
module.exports = {
    ...
    rules: {
        ...
        'logical-top-to-bottom-grouping': logical_top_to_bottom_grouping_1.logicalTopToBottomGrouping,
        ...
        'react-memoize-literals': react_memoize_literals_1.reactMemoizeLiterals,
        ...
        'no-handler-suffix': no_handler_suffix_1.noHandlerSuffix,
        ...
        'prefer-getter-over-parameterless-method': prefer_getter_over_parameterless_method_1.preferGetterOverParameterlessMethod,
        ...
        'require-memoize-jsx-returners': require_memoize_jsx_returners_1.requireMemoizeJsxReturners,
        'no-unmemoized-memo-without-props': no_unmemoized_memo_without_props_1.noUnmemoizedMemoWithoutProps,
        ...
        'enforce-storage-context': enforce_storage_context_1.enforceStorageContext,
        ...
        'no-redundant-annotation-assertion': no_redundant_annotation_assertion_1.noRedundantAnnotationAssertion,
        'no-redundant-param-types': no_redundant_param_types_1.noRedundantParamTypes,
        'no-redundant-this-params': no_redundant_this_params_1.noRedundantThisParams,
        ...
        'prefer-docsetter-setall': prefer_docsetter_setall_1.preferDocSetterSetAll,
        ...
        'enforce-transform-memoization': enforce_transform_memoization_1.enforceTransformMemoization,
        ...
        'flatten-push-calls': flatten_push_calls_1.flattenPushCalls,
        'enforce-timestamp-now': enforce_timestamp_now_1.enforceTimestampNow,
        'enforce-unique-cursor-headers': enforce_unique_cursor_headers_1.enforceUniqueCursorHeaders,
        ...
        'no-unnecessary-destructuring-rename': no_unnecessary_destructuring_rename_1.noUnnecessaryDestructuringRename,
        'enforce-singular-type-names': enforce_singular_type_names_1.enforceSingularTypeNames,
        'prevent-children-clobber': prevent_children_clobber_1.preventChildrenClobber,
        ...
        'no-useless-usememo-primitives': no_useless_usememo_primitives_1.noUselessUsememoPrimitives,
        'prefer-usecallback-over-usememo-for-functions': prefer_usecallback_over_usememo_for_functions_1.default,
        'no-usememo-for-pass-by-value': no_usememo_for_pass_by_value_1.noUsememoForPassByValue,
        ...
        'no-empty-dependency-use-callbacks': no_empty_dependency_use_callbacks_1.noEmptyDependencyUseCallbacks,
        ...
        'jsdoc-above-field': jsdoc_above_field_1.jsdocAboveField,
        ...
        'no-console-error': no_console_error_1.noConsoleError,
        ...
        'no-curly-brackets-around-commented-properties': no_curly_brackets_around_commented_properties_1.noCurlyBracketsAroundCommentedProperties,
