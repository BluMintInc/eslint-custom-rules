...
export const noUnpinnedDependencies: TSESLint.RuleModule<
    'unexpected',
    any[]
> = createRule({
    meta: {
        ...
        return {
            JSONLiteral(node: AST.JSONLiteral) {
                ...
                if (
                    ...
                    ((configKey as JSONIdentifier).name === 'devDependencies' || (configKey as JSONLiteral).value === 'devDependencies' ||
                    (configKey as JSONIdentifier).name === 'dependencies' || (configKey as JSONLiteral).value === 'dependencies')
                ) {
