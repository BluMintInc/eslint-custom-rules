...
* **class-methods-read-top-to-bottom:** preserve the handed `this` context (closes [#2193](https://github.com/BluMintInc/eslint-custom-rules/issues/2193)) ([f930955](https://github.com/BluMintInc/eslint-custom-rules/commit/f930955b18865df365b410dd92ecc46f49fe507a))
* **enforce-dynamic-firebase-imports:** apply the reach boundary to the handed node (closes [#2172](https://github.com/BluMintInc/eslint-custom-rules/issues/2172), closes [#2173](https://github.com/BluMintInc/eslint-custom-rules/issues/2173)) ([f7c9244](https://github.com/BluMintInc/eslint-custom-rules/commit/f7c9244f85135ed0dd16f8457fcd01b164bf02ff))
* **enforce-firestore-doc-ref-generic:** read an interface's body, not only extends (closes [#2189](https://github.com/BluMintInc/eslint-custom-rules/issues/2189)) ([7935ec9](https://github.com/BluMintInc/eslint-custom-rules/commit/7935ec98d1032ff22fef825aeca3311211d1cb5a))
* **enforce-positive-naming:** read the function under a type-only wrapper and on a property signature (closes [#2174](https://github.com/BluMintInc/eslint-custom-rules/issues/2174), closes [#2175](https://github.com/BluMintInc/eslint-custom-rules/issues/2175)) ([b9913ee](https://github.com/BluMintInc/eslint-custom-rules/commit/b9913eedf68736c8522848817b5b11b9c6a1be11))
* **enforce-props-argument-name:** scan for readers of a public parameter property beyond its class (closes [#2177](https://github.com/BluMintInc/eslint-custom-rules/issues/2177)) ([839db2e](https://github.com/BluMintInc/eslint-custom-rules/commit/839db2e385d4bee92bb3f7adcacc26085af9a61f))
* **enforce-props-naming-consistency:** adopt the sibling's class boundary, subclass carve-out and param unwrap (closes [#2178](https://github.com/BluMintInc/eslint-custom-rules/issues/2178), closes [#2179](https://github.com/BluMintInc/eslint-custom-rules/issues/2179), closes [#2180](https://github.com/BluMintInc/eslint-custom-rules/issues/2180)) ([26c623f](https://github.com/BluMintInc/eslint-custom-rules/commit/26c623f2dd4f6a24ed3099b70a782857cd80da57)), closes [#2177](https://github.com/BluMintInc/eslint-custom-rules/issues/2177) [#1276](https://github.com/BluMintInc/eslint-custom-rules/issues/1276)
* **logical-top-to-bottom-grouping:** resolve callees in parameter defaults (closes [#2195](https://github.com/BluMintInc/eslint-custom-rules/issues/2195)) ([afc9f52](https://github.com/BluMintInc/eslint-custom-rules/commit/afc9f527df8de597f7c37eed68f843900e5ff727))
* **no-empty-dependency-use-callbacks:** limit the JSX exemption to a renderer (closes [#2192](https://github.com/BluMintInc/eslint-custom-rules/issues/2192)) ([6130f11](https://github.com/BluMintInc/eslint-custom-rules/commit/6130f1193b7edaa50c02e4d5d70f4785660cc939))
* **no-filter-without-return:** stop hasReturnStatement at function-scope boundaries (closes [#2194](https://github.com/BluMintInc/eslint-custom-rules/issues/2194)) ([0c9861f](https://github.com/BluMintInc/eslint-custom-rules/commit/0c9861fc8d5f78618bcc3036bed0d9d9a8b2108d))
* **no-misleading-boolean-prefixes:** see the function through a type-only wrapper at the naming site (closes [#2176](https://github.com/BluMintInc/eslint-custom-rules/issues/2176)) ([75104f5](https://github.com/BluMintInc/eslint-custom-rules/commit/75104f5888ea30074feca94693be92847e24d5dc))
* **no-unmemoized-memo-without-props:** hand returnsJSX the function, not its body (closes [#2190](https://github.com/BluMintInc/eslint-custom-rules/issues/2190)) ([0d59191](https://github.com/BluMintInc/eslint-custom-rules/commit/0d59191ae75b62502bcc48dc13ab6e1b1104aff9))
* **no-unused-props:** make the rebind gate prune the statement list, and expand utility types inside an intersection (closes [#2185](https://github.com/BluMintInc/eslint-custom-rules/issues/2185), closes [#2187](https://github.com/BluMintInc/eslint-custom-rules/issues/2187), closes [#2188](https://github.com/BluMintInc/eslint-custom-rules/issues/2188)) ([db068b6](https://github.com/BluMintInc/eslint-custom-rules/commit/db068b6ce0d4ab6b5a968f4a7dc851da0846c98d))
* **parallelize-async-operations:** scan unbraced switch-case consequents (closes [#2204](https://github.com/BluMintInc/eslint-custom-rules/issues/2204)) ([cff4b7c](https://github.com/BluMintInc/eslint-custom-rules/commit/cff4b7c24a7ad05e5d8eeb5393eaee83c355980e))
* **prefer-utility-function-own-file:** read a function's own parameter list, not just its body (closes [#2197](https://github.com/BluMintInc/eslint-custom-rules/issues/2197), closes [#2199](https://github.com/BluMintInc/eslint-custom-rules/issues/2199), closes [#2200](https://github.com/BluMintInc/eslint-custom-rules/issues/2200)) ([741cc77](https://github.com/BluMintInc/eslint-custom-rules/commit/741cc77d18fd5a7691f5710b05b111c7d2a7f817))
* **prevent-children-clobber:** ask isComponentLike about the function, not its body (closes [#2191](https://github.com/BluMintInc/eslint-custom-rules/issues/2191)) ([418e10f](https://github.com/BluMintInc/eslint-custom-rules/commit/418e10fb04c020f700cf9be84be97050753456e1))
* **react-memoize-literals:** key the JSX-member carve-out on the value, not the container or the spelling (closes [#2202](https://github.com/BluMintInc/eslint-custom-rules/issues/2202), closes [#2203](https://github.com/BluMintInc/eslint-custom-rules/issues/2203)) ([33a0b59](https://github.com/BluMintInc/eslint-custom-rules/commit/33a0b59883f2e4649badb6265af31d8614827a25))
* **react-usememo-should-be-component:** descend into blocks nested below the top level (closes [#2201](https://github.com/BluMintInc/eslint-custom-rules/issues/2201)) ([115f59f](https://github.com/BluMintInc/eslint-custom-rules/commit/115f59fd7d31f039704e858787ed8429404bb476))
* **require-memo:** resolve a concise arrow body's identifier to its initializer (closes [#2186](https://github.com/BluMintInc/eslint-custom-rules/issues/2186)) ([2befe97](https://github.com/BluMintInc/eslint-custom-rules/commit/2befe972014a5bc0086b7c7fafa9f7fa1b97f92d))
* **require-props-composition:** apply each walk's behaviour to the node it is handed (closes [#2181](https://github.com/BluMintInc/eslint-custom-rules/issues/2181), closes [#2182](https://github.com/BluMintInc/eslint-custom-rules/issues/2182), closes [#2183](https://github.com/BluMintInc/eslint-custom-rules/issues/2183), closes [#2184](https://github.com/BluMintInc/eslint-custom-rules/issues/2184)) ([fab0231](https://github.com/BluMintInc/eslint-custom-rules/commit/fab02317ce88a546bd1bff9534cde830f70619ea))
* **vertically-group-related-functions:** record calls in parameter defaults as dependencies (closes [#2196](https://github.com/BluMintInc/eslint-custom-rules/issues/2196), closes [#2198](https://github.com/BluMintInc/eslint-custom-rules/issues/2198)) ([6598198](https://github.com/BluMintInc/eslint-custom-rules/commit/6598198c6b4d929f50a1c5330be8d783c8e56121))
